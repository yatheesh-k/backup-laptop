...
public class EmployeeController {
    ...
    public ResponseEntity<?> getEmployeeAccountDetails(@Parameter(hidden = true, required = true, description = "${apiAuthToken.description}", example = "Bearer abcdef12-1234-1234-1234-abcdefabcdef}")
        ...
        List<EmployeeResponseEntity> employeeResponseEntity = employeeService.getEmployeesAccountsDetails(companyName);
        return new ResponseEntity<>(
                ResponseBuilder.builder().build().createSuccessResponse(employeeResponseEntity), HttpStatus.OK);
    }
