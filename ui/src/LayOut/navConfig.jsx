  ...
  company_admin: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: "Candidate Documents Upload",
    ...
    },
    {
      ...
      icon: "people",
      items: [
        { title: "Employee Summary", path: "/employeeSummary" },
        { title: "Employee Registration", path: "/employeeManagement" },
      ],
    },
    {
      title: "Employees",
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Timeline Dates", path: "/timelineDates" },
      ],
    },
  ],
  Admin: [
