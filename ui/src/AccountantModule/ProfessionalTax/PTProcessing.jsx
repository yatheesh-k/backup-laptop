...
const PTProcessing = () => {
  ...
  const downloadApprovalListExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "PT Approval List");
    XLSX.writeFile(wb, `PT_Approval_${approvalMonth}_${approvalYear}.xlsx`);
  };
        ...
        <div className="row d-flex align-items-center justify-content-between mt-1 mb-2">
          <div className="col">
            <h1 className="h3 mb-3">
              <strong>Accounts Professional Tax Processing</strong>
            </h1>
          </div>
          <div className="col-auto" style={{ paddingBottom: "20px" }}>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb mb-0">
                ...
                <li className="breadcrumb-item active">Professional Tax Processing</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div className="card">
              <div className="card-header">
                <h5 className="card-title mb-0">
                  Professional Tax Payment Processing
                </h5>
              </div>
