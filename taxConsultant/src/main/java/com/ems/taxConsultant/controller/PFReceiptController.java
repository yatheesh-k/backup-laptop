...
public class PFReceiptController {
    ...
    public ResponseEntity<?> addPFReceipts(@Parameter(hidden = true, required = true, description = "${apiAuthToken.description}", example = "Bearer abcdef12-1234-1234-1234-abcdefabcdef")
                                           ...
                                           @ModelAttribute @Valid PFReceiptsRequest request) throws TaxConsultantException {
    ...
    public ResponseEntity<?> getPfReceipts(
        ...
        if (receipts.isEmpty()) {
            ...
            throw new TaxConsultantException(ErrorMessageHandler.getMessage(ErrorMessageKey.PF_RECEIPTS_NOT_FOUND), HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> updatePFReceipt(
            ...
            @Valid @RequestBody PFReceiptUpdateRequest updateRequest) throws TaxConsultantException {
