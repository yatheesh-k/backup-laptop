...
@Component
public class TDSReceiptsDaoImpl extends AbstractDao<TDSReceiptEntity> implements TDSReceiptsDao {

    public TDSReceiptsDaoImpl(Repository repository) {super(repository);}

    @Override
    public Collection<TDSReceiptEntity> getTDSReceipts(String companyName, String companyId, String tdsReceiptsId, String month, String year) throws TaxConsultantException {
    ...
    Collection<Filter> filters = new ArrayList<>();
        ...
        if (StringUtils.isNotBlank(tdsReceiptsId)) {
            filters.add(new Filter(Constants.ID, Operator.EQ, tdsReceiptsId));
        }
