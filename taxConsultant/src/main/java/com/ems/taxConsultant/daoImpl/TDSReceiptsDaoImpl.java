...
public class TDSReceiptsDaoImpl extends AbstractDao<TDSReceiptEntity> implements TDSReceiptsDao {
    ...
    @Override
    public Collection<TDSReceiptEntity> getTDSReceipts(String companyName, String companyId, String tdsReceiptsId, String month, String year) throws AccountantException{
