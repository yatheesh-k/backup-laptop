...
import com.ems.taxConsultant.model.ResourceType;
...
public class ResourceIdUtils {
    ...
    public static String generateDueDatesResourceId(String id) {
        return generateGlobalResourceId(ResourceType.DUE_DATES, id);
    }
